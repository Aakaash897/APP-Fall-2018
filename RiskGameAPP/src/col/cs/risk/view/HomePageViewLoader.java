	...
	public static void loadHomePage(StartGameController startController) {
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup()
										...
										.addGroup(groupLayout.createParallelGroup(Alignment.CENTER)
												...
												.addGap(50)
												.addComponent(startController.getConstructMapButton(),GroupLayout.DEFAULT_SIZE, 100, 500)
												.addGap(50)
												.addComponent(startController.getLoadExistingMapButton(),GroupLayout.DEFAULT_SIZE, 100, 500)
												.addGap(50)
		...
		groupLayout.setVerticalGroup(
				...
				.addGroup(groupLayout.createSequentialGroup()
						...
						.addPreferredGap(ComponentPlacement.RELATED, 8, Short.MAX_VALUE)
						.addComponent(startController.getExitButton())
						.addContainerGap())
				);
